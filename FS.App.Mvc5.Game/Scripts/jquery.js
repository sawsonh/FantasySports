...
!function(a, b) {
    ...
    function(a, b) {
                        ...
                        (ib(function(a) {
                            a.innerHTML =
                                ...
                                a.querySelectorAll("[msallowclip^='']").length &&
                                    ...
                                    q.push("\\[" + M + "*(?:value|" + L + ")"), a.querySelectorAll(":checked").length ||
                                    q.push(":checked")
                        }), ib(function(a) {
                            var b = e.createElement("input");
                            b.setAttribute("type", "hidden"), a.appendChild(b).setAttribute("name", "D"),
                                a.querySelectorAll("[name=d]").length && q.push("name" + M + "*[*^$|!~]?="), a
                ...
                preFilter: {
                    ATTR: function(a) {
                        return a[1] = a[1].replace(cb, db), a[3] =
                            (a[3] || a[4] || a[5] || "").replace(cb, db), "~=" === a[2] && (a[3] = " " + a[3] + " "), a
                            .slice(0, 4)
                    },
                    CHILD: function(a) {
                ...
                return c = y.getElementsByTagName("body")[0], c && c.style
                    ? (b = y.createElement("div"), d = y.createElement("div"), d.style.cssText =
                        ...
                        (b.style.cssText =
                            ...
                            b.appendChild(y.createElement("div")).style.width = "5px", a =
                                3 !== b.offsetWidth), c.removeChild(d), a)
                    : void 0
            }
        }();
        var Gb = /^margin/,
        ...
        m.fn.extend({
            ...
            m.each(["href", "src"],
                function(a, b) {
                    m.propHooks[b] = { get: function(a) { return a.getAttribute(b, 4) } }
                }), k.optSelected ||
            ...
            ajax: function(a, b) {
                ...
                function x(a, b, c, d) {
                    ...
                    (t = 2, g && clearTimeout(g), i = void 0, f = d || "", v.readyState = a > 0 ? 4 : 0, j =
                            ...
                            : o.rejectWith(l, [v, x, s]), v.statusCode(q),
